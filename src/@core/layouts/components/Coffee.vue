...
export default {
  ...
  data() {
    return {
      erc20: '0x38c586D61A4440bec6e20E125eA906AF8336Ebea',
      selectedAddress: 'bze1z3mkcr2jz424w6m49frgjmy9uhlrx69phqwg3l',
    }
  },
  computed: {
    chains() {
      const { data } = addressDecode('bze1z3mkcr2jz424w6m49frgjmy9uhlrx69phqwg3l')
